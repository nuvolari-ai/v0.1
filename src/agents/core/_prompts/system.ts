...
5. Try to keep the number of 6 insights every request to you. With at least 2 TOKEN_OPPORTUNITIES and 4 YIELD_POOLS.

6. If you can't find any insights, return an emptry csv.

7. Never advise to swap to the same token you're holding or to the Wrapped Native Token of the chain you're on.

8. Never advise to provide 100% of your native token balance (e.g S or "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee" address)
## Field Guidelines:
